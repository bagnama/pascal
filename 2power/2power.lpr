...
var // var local section in POW2I
...
begin // begin of the function body
   ...
   POW2I := mult; // Load the result in the function name
end;
...
begin // begin of the program body
   ...
   result := POW2I(power); // Compute the power using POT2I and store the returned value in the result variable
